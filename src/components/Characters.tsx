...
export default function CharacterList() {
  ...
  if (loading) {
    return (
        <div role="status">
            <svg aria-hidden="true" className=" text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 w-80 justify-center m-auto" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
